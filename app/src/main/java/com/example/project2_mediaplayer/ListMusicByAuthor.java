...
public class ListMusicByAuthor extends AppCompatActivity {
    ...
    private MusicAdapter musicByAuthorAdapter;
...
//                System.out.println("bundle null");
        ...
        getListMusicByAuthor();
        rcvMusic = findViewById(R.id.rcv_musicbyauthor);
        musicByAuthorAdapter = new MusicAdapter(this, list);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
        rcvMusic.setLayoutManager(layoutManager);


        musicByAuthorAdapter.setData(list);

        rcvMusic.setAdapter(musicByAuthorAdapter);
        }

    private List<Music> getListMusicByAuthor() {
...
//                        System.out.println(music.getSongTitle());
                    ...
                    musicByAuthorAdapter.notifyDataSetChanged();
                }
            }
